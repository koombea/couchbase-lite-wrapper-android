...
//        val productList = productDatabase.fetchAll(whereExpression = whereExpression)
//        printList(productList)
//    }
//
//    private fun printAllSortedByQuantityDescending() {
//        val orderBy = arrayOf(Ordering.property("attributes.quantity").descending())
//        val productList = productDatabase.fetchAll(orderedBy = orderBy)
//        printList(productList)
//    }
//
...
//        val productList = productDatabase.fetchAll()
//        printList(productList)
//    }
//
